...
# --- STILIZACIJA (Pulsirajuće dugme) ---
st.markdown("""
    <style>
    /* Animacija za zeleno pulsiranje */
    ...
    /* Animacija za crveno pulsiranje */
    @keyframes pulse-red {
